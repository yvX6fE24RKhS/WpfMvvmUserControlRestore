//1.0.8675.*//
//Ignore Spelling: silverlight gridlength 
...
#pragma warning restore IDE0130 // Пространство имен (namespace) не соответствует структуре папок.
{
   ...
   /// </summary>
   /// <remarks><see href=""/>https://www.codeproject.com/Articles/233886/Tidy-Up-XAML-with-the-ApexGrid</remarks>
   public class ApexGrid : Grid
   {
      ...
      {
         //  Get the apex grid.
         ApexGrid apexGrid = (ApexGrid)dependencyObject;
